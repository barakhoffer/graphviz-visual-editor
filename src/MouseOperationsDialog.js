...
const mouseOperations = [
  ...
  {key: 'Double-click a node', description: 'Rename the node (or connect edge if drawing).'},
  {key: 'Ctrl+Double-click a node', description: 'Edit the node label.'},
  {key: 'Double-click an edge', description: 'Edit the edge xlabel (external label).'},
